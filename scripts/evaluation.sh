...
# python evaluation.py --config_file configs/seq2seqlm_flan-t5-xl-e5-large-v2-pretrain-filter.json --last_layer_only True --overwrite_results False
...
# python evaluation.py --config_file configs/causallm_llama-2-7b-e5-large-v2-qa.json --last_layer_only False --overwrite_results True
# python evaluation.py --config_file configs/causallm_llama-2-7b-e5-large-v2-qa-ml=40.json --last_layer_only False --overwrite_results True
...
# ===== robustness =====
# python robust_evaluation.py --config_file configs/causallm_llama-2-7b-qa.json --last_layer_only True --overwrite_results True
